...
public sealed class InventoryForbiddenAuthorizationTests(InventoryApiFactory factory)
    : IClassFixture<InventoryApiFactory>
{
    ...
    public async Task GetInventoryItems_WithCustomerRole_ReturnsForbidden()
    {
    ...
    [Fact]
    [Trait("Category", "Integration")]
    public async Task GetInventoryItemByProductId_WithCustomerRole_ReturnsForbidden()
    {
        using var client = _factory.CreateCustomerClient();
    ...
    [Fact]
    [Trait("Category", "Integration")]
    public async Task CreateInventoryItem_WithSupportRole_ReturnsForbidden()
    {
    ...
    [Fact]
    [Trait("Category", "Integration")]
    public async Task UpdateInventoryItem_WithSupportRole_ReturnsForbidden()
    {
        using var client = _factory.CreateSupportClient();
