    ...
    : IConfigureOptions<SwaggerGenOptions>
{
    ...
    private static OpenApiInfo CreateOpenApiInfo(ApiVersionDescription description)
    {
        var info = new OpenApiInfo
        {
            ...
            Description = "HTTP API for managing inventory items. Stock reservation is processed asynchronously from RabbitMQ events. Protected endpoints require a Keycloak JWT access token."
        };
