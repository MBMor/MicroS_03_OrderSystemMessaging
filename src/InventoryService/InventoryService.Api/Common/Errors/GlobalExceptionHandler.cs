...
namespace InventoryService.Api.Common.Errors;
...
public sealed class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> logger) : IExceptionHandler
{
        ...
        Exception exception)
    {
        var problemDetails = exception switch
        {
            ...
            DuplicateInventoryItemException duplicateInventoryItemException => new ProblemDetails
            {
                Status = StatusCodes.Status409Conflict,
                Title = "Duplicate inventory item.",
                Detail = duplicateInventoryItemException.Message,
                Instance = httpContext.Request.Path
            },

            InventoryItemNotFoundException inventoryItemNotFoundException => new ProblemDetails
            {
                Status = StatusCodes.Status404NotFound,
                Title = "Inventory item was not found.",
                Detail = inventoryItemNotFoundException.Message,
                Instance = httpContext.Request.Path
            },
