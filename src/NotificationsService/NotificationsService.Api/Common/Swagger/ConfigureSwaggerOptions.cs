    ...
    : IConfigureOptions<SwaggerGenOptions>
{
    ...
    private static OpenApiInfo CreateOpenApiInfo(ApiVersionDescription description)
    {
        var info = new OpenApiInfo
        {
            ...
            Description = "HTTP API for reading notifications created from asynchronous order processing events. Protected endpoints require a Keycloak JWT access token."
        };
