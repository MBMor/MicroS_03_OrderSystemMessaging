    ...
    ILogger<OrderCreatedNotificationConsumerBackgroundService> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            catch (Exception exception)
            {
                _logger.LogWarning(
                    exception,
                    "Notifications OrderCreated consumer failed. Retrying in {RetryDelaySeconds} second(s). ErrorType: {ErrorType}",
        ...
        BasicDeliverEventArgs eventArgs)
    {
        ...
        {
            throw new InvalidOperationException("OrderCreated notification message payload could not be deserialized.");
        }
