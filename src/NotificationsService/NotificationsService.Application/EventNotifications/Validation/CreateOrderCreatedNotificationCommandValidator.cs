...
public sealed class CreateOrderCreatedNotificationCommandValidator
    : AbstractValidator<CreateOrderCreatedNotificationCommand>
{
    public CreateOrderCreatedNotificationCommandValidator()
    {
